...
Version  : 4.67
Release  : 59
URL      : https://files.pythonhosted.org/packages/eb/f1/841f0cc27a497d7f89842104889795537cb6ecd1928db119d4d3ddebe560/gsutil-4.67.tar.gz
Source0  : https://files.pythonhosted.org/packages/eb/f1/841f0cc27a497d7f89842104889795537cb6ecd1928db119d4d3ddebe560/gsutil-4.67.tar.gz
...
%prep
%setup -q -n gsutil-4.67
cd %{_builddir}/gsutil-4.67
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1629158324
...
cp %{_builddir}/gsutil-4.67/LICENSE %{buildroot}/usr/share/package-licenses/gsutil/2b8b815229aa8a61e483fb4ba0588b8b6c491890
cp %{_builddir}/gsutil-4.67/gslib/vendored/boto/LICENSE %{buildroot}/usr/share/package-licenses/gsutil/875c7866415e9e58a4c515bd052d001ac5107943
cp %{_builddir}/gsutil-4.67/gslib/vendored/oauth2client/LICENSE %{buildroot}/usr/share/package-licenses/gsutil/a7b6feb97b476557d3d699fa1f20090fb956d662
