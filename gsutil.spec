...
Version  : 5.2
Release  : 62
URL      : https://files.pythonhosted.org/packages/6e/44/b54142efd7de9bdfcceaa9dac9dcd478ba4b77dba1f4ed4a16ffe131f1f5/gsutil-5.2.tar.gz
Source0  : https://files.pythonhosted.org/packages/6e/44/b54142efd7de9bdfcceaa9dac9dcd478ba4b77dba1f4ed4a16ffe131f1f5/gsutil-5.2.tar.gz
...
%prep
%setup -q -n gsutil-5.2
cd %{_builddir}/gsutil-5.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1632493364
...
cp %{_builddir}/gsutil-5.2/LICENSE %{buildroot}/usr/share/package-licenses/gsutil/2b8b815229aa8a61e483fb4ba0588b8b6c491890
cp %{_builddir}/gsutil-5.2/gslib/vendored/boto/LICENSE %{buildroot}/usr/share/package-licenses/gsutil/875c7866415e9e58a4c515bd052d001ac5107943
cp %{_builddir}/gsutil-5.2/gslib/vendored/oauth2client/LICENSE %{buildroot}/usr/share/package-licenses/gsutil/a7b6feb97b476557d3d699fa1f20090fb956d662
