...
Source0  : https://files.pythonhosted.org/packages/8c/f0/60b01adee06e93eaf179c9de771d6578b2c76a904636a4f283bd37acc8e7/gsutil-4.60.tar.gz
...
%prep
%setup -q -n gsutil-4.60
cd %{_builddir}/gsutil-4.60
%patch1 -p1
%patch2 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1615503265
...
cp %{_builddir}/gsutil-4.60/LICENSE %{buildroot}/usr/share/package-licenses/gsutil/2b8b815229aa8a61e483fb4ba0588b8b6c491890
cp %{_builddir}/gsutil-4.60/gslib/vendored/boto/LICENSE %{buildroot}/usr/share/package-licenses/gsutil/875c7866415e9e58a4c515bd052d001ac5107943
cp %{_builddir}/gsutil-4.60/gslib/vendored/oauth2client/LICENSE %{buildroot}/usr/share/package-licenses/gsutil/a7b6feb97b476557d3d699fa1f20090fb956d662
