...
Version  : 5.3
Release  : 63
URL      : https://files.pythonhosted.org/packages/da/77/ada859c0d518356a8a09ca94343ff7c694168d509f78fee8ba648220ebd7/gsutil-5.3.tar.gz
Source0  : https://files.pythonhosted.org/packages/da/77/ada859c0d518356a8a09ca94343ff7c694168d509f78fee8ba648220ebd7/gsutil-5.3.tar.gz
...
%prep
%setup -q -n gsutil-5.3
cd %{_builddir}/gsutil-5.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1633101995
...
cp %{_builddir}/gsutil-5.3/LICENSE %{buildroot}/usr/share/package-licenses/gsutil/2b8b815229aa8a61e483fb4ba0588b8b6c491890
cp %{_builddir}/gsutil-5.3/gslib/vendored/boto/LICENSE %{buildroot}/usr/share/package-licenses/gsutil/875c7866415e9e58a4c515bd052d001ac5107943
cp %{_builddir}/gsutil-5.3/gslib/vendored/oauth2client/LICENSE %{buildroot}/usr/share/package-licenses/gsutil/a7b6feb97b476557d3d699fa1f20090fb956d662
