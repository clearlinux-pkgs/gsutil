...
Version  : 4.66
Release  : 58
URL      : https://files.pythonhosted.org/packages/54/b4/5bc73844f0652515a74acc2fba68b15b19d0a60a420129daf73537d554db/gsutil-4.66.tar.gz
Source0  : https://files.pythonhosted.org/packages/54/b4/5bc73844f0652515a74acc2fba68b15b19d0a60a420129daf73537d554db/gsutil-4.66.tar.gz
...
%prep
%setup -q -n gsutil-4.66
cd %{_builddir}/gsutil-4.66
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1627598793
...
cp %{_builddir}/gsutil-4.66/LICENSE %{buildroot}/usr/share/package-licenses/gsutil/2b8b815229aa8a61e483fb4ba0588b8b6c491890
cp %{_builddir}/gsutil-4.66/gslib/vendored/boto/LICENSE %{buildroot}/usr/share/package-licenses/gsutil/875c7866415e9e58a4c515bd052d001ac5107943
cp %{_builddir}/gsutil-4.66/gslib/vendored/oauth2client/LICENSE %{buildroot}/usr/share/package-licenses/gsutil/a7b6feb97b476557d3d699fa1f20090fb956d662
