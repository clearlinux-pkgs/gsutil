...
Source0  : https://files.pythonhosted.org/packages/04/32/268098abebab37c7eac8c2808acae37597b7a921abc5e3cd8baa6b1ae2fa/gsutil-4.59.tar.gz
...
%prep
%setup -q -n gsutil-4.59
cd %{_builddir}/gsutil-4.59
%patch1 -p1
%patch2 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1614878984
...
cp %{_builddir}/gsutil-4.59/LICENSE %{buildroot}/usr/share/package-licenses/gsutil/2b8b815229aa8a61e483fb4ba0588b8b6c491890
cp %{_builddir}/gsutil-4.59/gslib/vendored/boto/LICENSE %{buildroot}/usr/share/package-licenses/gsutil/875c7866415e9e58a4c515bd052d001ac5107943
cp %{_builddir}/gsutil-4.59/gslib/vendored/oauth2client/LICENSE %{buildroot}/usr/share/package-licenses/gsutil/a7b6feb97b476557d3d699fa1f20090fb956d662
