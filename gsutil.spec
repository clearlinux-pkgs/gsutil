...
Version  : 5.1
Release  : 61
URL      : https://files.pythonhosted.org/packages/12/05/77c749fd3c870a729f21f35effb976cb1a47b0f6ff228199e407015a8353/gsutil-5.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/12/05/77c749fd3c870a729f21f35effb976cb1a47b0f6ff228199e407015a8353/gsutil-5.1.tar.gz
...
%prep
%setup -q -n gsutil-5.1
cd %{_builddir}/gsutil-5.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1632437424
...
cp %{_builddir}/gsutil-5.1/LICENSE %{buildroot}/usr/share/package-licenses/gsutil/2b8b815229aa8a61e483fb4ba0588b8b6c491890
cp %{_builddir}/gsutil-5.1/gslib/vendored/boto/LICENSE %{buildroot}/usr/share/package-licenses/gsutil/875c7866415e9e58a4c515bd052d001ac5107943
cp %{_builddir}/gsutil-5.1/gslib/vendored/oauth2client/LICENSE %{buildroot}/usr/share/package-licenses/gsutil/a7b6feb97b476557d3d699fa1f20090fb956d662
