...
Version  : 4.63
Release  : 53
URL      : https://files.pythonhosted.org/packages/6a/fc/b0200efe90fa46eddf65df967ffe9bdfd2d42fc7777c88f2a8b50cd67361/gsutil-4.63.tar.gz
Source0  : https://files.pythonhosted.org/packages/6a/fc/b0200efe90fa46eddf65df967ffe9bdfd2d42fc7777c88f2a8b50cd67361/gsutil-4.63.tar.gz
...
%prep
%setup -q -n gsutil-4.63
cd %{_builddir}/gsutil-4.63
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1623342599
...
cp %{_builddir}/gsutil-4.63/LICENSE %{buildroot}/usr/share/package-licenses/gsutil/2b8b815229aa8a61e483fb4ba0588b8b6c491890
cp %{_builddir}/gsutil-4.63/gslib/vendored/boto/LICENSE %{buildroot}/usr/share/package-licenses/gsutil/875c7866415e9e58a4c515bd052d001ac5107943
cp %{_builddir}/gsutil-4.63/gslib/vendored/oauth2client/LICENSE %{buildroot}/usr/share/package-licenses/gsutil/a7b6feb97b476557d3d699fa1f20090fb956d662
