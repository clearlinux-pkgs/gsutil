...
Version  : 4.65
Release  : 56
URL      : https://files.pythonhosted.org/packages/78/bf/9665adca43740ca4a0adde1525da1590d9ce65189cec17abd86a7ab30f75/gsutil-4.65.tar.gz
Source0  : https://files.pythonhosted.org/packages/78/bf/9665adca43740ca4a0adde1525da1590d9ce65189cec17abd86a7ab30f75/gsutil-4.65.tar.gz
...
%prep
%setup -q -n gsutil-4.65
cd %{_builddir}/gsutil-4.65
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1625582317
...
cp %{_builddir}/gsutil-4.65/LICENSE %{buildroot}/usr/share/package-licenses/gsutil/2b8b815229aa8a61e483fb4ba0588b8b6c491890
cp %{_builddir}/gsutil-4.65/gslib/vendored/boto/LICENSE %{buildroot}/usr/share/package-licenses/gsutil/875c7866415e9e58a4c515bd052d001ac5107943
cp %{_builddir}/gsutil-4.65/gslib/vendored/oauth2client/LICENSE %{buildroot}/usr/share/package-licenses/gsutil/a7b6feb97b476557d3d699fa1f20090fb956d662
